...
<html>
  ...
  <input class="border" type="button" onclick="location='deletesale.jsp'" value="删除出售物品">
      ...
      <table width="100%" align="center" border="1" cellpadding="10">
          ...
          <tr height="2">
              ...
              %>
                  <tr height="2">
                  <td colspan=5>                  
                  <form action="action/deletegoodsaction.jsp" method="post">
